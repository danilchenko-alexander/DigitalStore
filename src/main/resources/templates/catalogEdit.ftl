...
<div class="col-sm-3 mt-sm-3 text-center">
    <form method="post" action="/catalogList/addSubcatalog">
        ...
        <div class="form-group">
            <label for="formp4"> добавить новый подкаталог</label>
    ...
    <#list subcatalogs as subcatalog>
        <div>
            <a class="btn btn-primary" style="width: 100%;" href="/catalogList/${catalogName}/edit/${subcatalog.id}">${subcatalog.name}</a>
        </div>
    </#list>
    </div>
</div>
